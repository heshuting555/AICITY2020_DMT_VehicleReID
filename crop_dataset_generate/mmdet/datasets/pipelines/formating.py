...
class Default_load(object):
    ...
    def __call__(self, results):
        ...
        if mode == 1:
            ...
            results['img']  = F.max_pool2d(results['img'] , kernel_size=3, stride=1, padding=1)
            results['img'] = -results['img']
        #else:
            #results['img'] = F.max_pool2d(results['img'], kernel_size=11, stride=1, padding=5)
...
@PIPELINES.register_module
class DefaultFormatBundle_min(object):
    """Default formatting bundle.
