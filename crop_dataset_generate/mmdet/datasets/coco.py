...
class CocoDataset(CustomDataset):
    ...
    def _filter_imgs(self, min_size=32):
        ...
        for i, img_info in enumerate(self.img_infos):
            if img_info['file_name']=="img_0026799.jpg" or img_info['file_name']=="img_0022476.jpg" :
                print('images img_0026799 or img_0022476 need to be continued ')
                continue
            if img_info['width']==658:
                continue
