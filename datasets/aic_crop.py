...
class AIC_CROP(BaseImageDataset):
    """
    VR
    ...
    def __init__(self, root='../data', plus_num_id=100, verbose=True, **kwargs):
        super(AIC_CROP, self).__init__()
        ...
        self.train_dir = osp.join(self.dataset_dir, 'image_train_crop_0403')
        self.query_dir = osp.join(self.dataset_dir, 'image_query_crop_0403')
        self.gallery_dir = osp.join(self.dataset_dir, 'image_test_crop_0403')
        self.plus_num_id = plus_num_id
